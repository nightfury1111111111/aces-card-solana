...
const App = () => {
  ...
  const gameId = ["18", "19", "20"].indexOf(String(utc.getDate()).padStart(2, '0')) !== -1 
    ? "tourney05card" 
    : String(utc.getDate()).padStart(2,'0') + String(utc.getMonth()).padStart(2,'0') + String(utc.getFullYear()) + gameType;
